...
public class UserControl {
    ...
    public String userListShow(Model model){
        List<User> listOfUsers = userService.getllAllUser();
    ...
    public String saveUser(User user, RedirectAttributes redirectAttributes){
        ...
        redirectAttributes.addFlashAttribute("message","Felhasználó sikeresen elmentve");
    ...
    public String deleteUser(@PathVariable("id") Integer id,RedirectAttributes redirectAttributes){
        try {
            ...
            redirectAttributes.addFlashAttribute("message","Felhasználó sikeresen törölve lett " + id );
        } catch (UserNotFoundException e) {
